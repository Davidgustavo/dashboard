...
public interface UserDAO extends JpaRepository<User, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.resturante FROM Pedido entity WHERE entity.user.id = :id")
  public Page<Resturante> listResturante(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Pedido entity WHERE entity.user.id = :instanceId AND entity.resturante.id = :relationId")
  public int deleteResturante(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
